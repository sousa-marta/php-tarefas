...
//EXERCÍCIO 13
/* 
//Array dentro de array dentro de array @_@
$ceu = [
...
foreach ($ceu as $pais => $caracteristicas) {
    if ($caracteristicas["naAmerica"]) {      //aqui não precisa por == true
        echo "As cidades da $pais são:<br>";
        foreach ($caracteristicas["cidades"] as $cidade) {
            echo "- ".$cidade."<br>";
        }
    }
}
